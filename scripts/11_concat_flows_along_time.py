...
## Example usage
$ python 11_concat_flows_along_time.py -t ../sample/2017_Lan_ns7_nt1_rot0.0007_it0.000.nc ../sample/2017_Lan_ns7_nt1_rot0.0007_it0.002.nc --exclude_texts concat -o ../sample/2017_Lan_ns7_nt1_concat.nc
$ python 11_concat_flows_along_time.py -g ../sample/2017_Lan_ns7_nt1_rot0.0007_it*.nc --exclude_texts concat -o ../sample/2017_Lan_ns7_nt1_concat.nc
...
test_args = f"-g {sample_dir}/2017_Lan_ns7_nt1_rot0.0000_it*.nc".split()
test_args = f"-t {os.getenv('HOME')}/git/tcamv/data/2019_Dorian/2019_Dorian_ns7_nt2_0901.nc {os.getenv('HOME')}/git/tcamv/data/2019_Dorian/2019_Dorian_ns7_nt1_0901.nc".split()
...
if args.target is not None:
    fnames = pd.Series(args.target)
elif args.glob_strings is not None:
